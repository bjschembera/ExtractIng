 ...
 *       &lt;sequence>
 *         &lt;element ref="{urn:exptml:schema:draft:0.5}companyname"/>
 *         &lt;element ref="{urn:exptml:schema:draft:0.5}address" minOccurs="0"/>
 *         &lt;element ref="{urn:exptml:schema:draft:0.5}contact" minOccurs="0"/>
 ...
 *         &lt;element ref="{urn:exptml:schema:draft:0.5}url" maxOccurs="unbounded" minOccurs="0"/>
...
public class CompanyType {
     ...
     *     
     */
    public SmallTextType getCompanyname() {
        return companyname;
    }
     ...
     *     
     */
    public void setCompanyname(SmallTextType value) {
     ...
     *     
     */
    public SmallTextType getContact() {
        return contact;
    }
     ...
     *     
     */
    public void setContact(SmallTextType value) {
        this.contact = value;
    }
     ...
     * 
     */
    public List<UriType> getUrl() {
        if (url == null) {
            url = new ArrayList<UriType>();
        }
        return this.url;
    }
